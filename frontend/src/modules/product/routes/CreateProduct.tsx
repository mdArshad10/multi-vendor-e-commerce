...
import { ColorSelectorController } from "@/components/common/controller/ColorSelectorController";
        ...
        <>
            <DashboardLayout>
                ...
                <div className="px-6 pb-6">
                    <form onSubmit={form.handleSubmit(handleSubmit)} className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        {/* Left Column - Image Upload */}
                        <div className="space-y-4">
                            <h3 className="text-sm font-medium text-gray-900 dark:text-gray-100">Product Images</h3>
                            {!file ? (
                                <div
